...
class ItemScheduleController extends GetxController {
  ...
  ItemScheduleController(
      {required this.idxDay, required this.createStatus, this.idxItem});
  ...
  void prepareUpdateData() {
    ...
    var btsAtas =
        ctrl.jadwal![ctrl.getDayName(idxDay)][idxItem!]['jadwal'][1].split('.');
    var btsBawah =
        ctrl.jadwal![ctrl.getDayName(idxDay)][idxItem!]['jadwal'][0].split('.');
    txtHour1C.text = btsBawah[0];
    txtMinute1C.text = btsBawah[1];
    txtHour2C.text = btsAtas[0];
    txtMinute2C.text = btsAtas[1];
    txtTitleC.text = ctrl.jadwal![ctrl.getDayName(idxDay)][idxItem!]['title'];
    txtDescC.text =
        ctrl.jadwal![ctrl.getDayName(idxDay)][idxItem!]['deskripsi'];
  }
}
